...
//        }
    ...
    private void validateParameter(Service theService, Parameter theParam)
    {
        if (theParam.getParamType() == null)
        {
            ...
            System.out.println("theParam.getParamType(): "+theParam.getParamType().getURI());
        }

        if (theParam.getParamType().isDataType())
        {
            System.out.println("theParam is datatype: "+theParam.getURI()+" ("+theParam.getParamType().getURI()+")");
        }
            ...
            System.out.println("theParam is a class: "+theParam.getLocalName()+" ("+theParam.getParamType().getURI()+")");
        }
...
//org.mindswap.owl.OWLConfig.setStrictConversion(false);
            ...
            //OWLSValidatorReport report = validator.validate("http://www.mindswap.org/2004/owl-s/1.1/ZipCodeFinder.owl");
            OWLSValidatorReport report = validator.validate("http://127.0.0.1/services/1.1/new/car_price_service.owls");
            
            //OWLSValidatorReport report = validator.validate("http://127.0.0.1/services/1.0/car_price_service.owls");
            //OWLSValidatorReport report = validator.validate("file:/D:/tmp/car_price_service.owls");
