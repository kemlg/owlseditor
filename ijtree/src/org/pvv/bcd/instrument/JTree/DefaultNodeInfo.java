 ...
 * It bases its contents model on a <code>DefaultStyledDocument</code>.
 *
 * @see javax.swing.text.DefaultStyledDocument
 */
public class DefaultNodeInfo
   implements Serializable, NodeInfo, Copyable, DragOverData
{
   ...
   /**
    * Creates a new default node. It has a title of "<unnamed node>" and
    * an empty string for its textual contents.
    */
   ...
   /**
    * Creates a new node with the given title and an empty string for
    * contents.
    *
    * @param newhead Name for new node
    */
    ...
    *
    * @param newhead Name for new node
    * @param newtxt Textual content of new node
    ...
    *
    * @return Our textual contents or an empty string if there was none
    * CHANGED from String to Object /Daniel
    */
    ...
    *
    * @param newtxt New textual contents
    */
   public void setContents(Object userObject)
   {
   	...
   	try
      {
         ...
         m_document.insertString(0, newtxt, null);
      }
      catch (BadLocationException ex){}
      */
   ...
   */
    ...
    */
   public int getCurrentEffect() { return m_nDragOverEffect; }
