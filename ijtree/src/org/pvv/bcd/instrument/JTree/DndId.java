...
/**
 * This is the unique drag and drop id that is used for transfering node
   ...
   implements Serializable
{
   ...
   public long getInstrumentId() { return m_nInstrumentId ; }
   public long getOperationId() { return m_nOperationId ; }
