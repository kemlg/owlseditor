 ...
 * create <code>DefaultMutableTreeNode</code> type nodes
...
public class DefaultNodeFactory
   implements NodeFactory, UserObjectFactory
{
    ...
    *
    * @param node <code>Node</code> to clone
    *
   ...
   /**
    * Will create a default empty node. In the default implementaiton, this
    * is a node with a default
    * <code>DefaultNodeInfo</code> object as its user object.
    *
    * @param parent Parent of the new node to create, not used in the
    ...
    *
    * @param ob User object to insert into node
    *
    * @return Newly created node. The default implementation will return a
    * <code>DefaultMutableTreeNode</code>
    *
    ...
    * @link{#createNode(Object)} to
    * accomplish this.
    *
    * @param title Title of new node
    * @param contents Textual contents of new node
    *
    * @return Newly created node. The default implementation will return a
    * <code>DefaultMutableTreeNode</code>
    *
   ...
   /**
    * Sets the displayable title of a node. Typically called when
    * the user changes the node title by use of a CellEditor or similar.
    *
    * @param userobject Node to set title on. The default implementation
    * expects this to be a <code>DefaultNodeInfo</code> type object.
    * @param title New title to set on the node.
    */
    ...
    * data for one node.
    *
    * @param node Node to create a <code>Transferable</code> for. The default
    * implementation expects this to be a <code>DefaultMutableTreeNode</code>.
    * @param Unique DND id associated with this transfer.
    *
    * @return A <code>Transferable</code> suitable for transferring
    * the given node data.
    * The default implementation will return a <code>DefaultTransferable</code>.
    *
    ...
    *
    * @param nodes Nodes to create a <code>Transferable</code> for. The default
    * implementation expects these to be <code>DefaultMutableTreeNode</code>.
    * @param Unique DND id associated with this transfer.
    *
