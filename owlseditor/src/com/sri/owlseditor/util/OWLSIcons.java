...
public class OWLSIcons {
	...
	/*
	 * public static Icon getCreateIcon(String baseIconName) { return new
	 * OverlayIcon(baseIconName, 5, 4, "CreateStar", 13, 1); }
	 */
	private static Icon getCreateIcon(String icon) {
		/*
		 * return new OverlayIcon(createImageIcon(icon).getImage(), 5, 4,
		 * createImageIcon("images/CreateStar.gif").getImage(), 13, 1);
		 */
