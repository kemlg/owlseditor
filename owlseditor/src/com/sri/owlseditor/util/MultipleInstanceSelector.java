...
/**
 * A JPanel with an array of instance panes, of which only one instance can be
 * chosen. Common superclass for IOPRSelector and ServiceSelector. A
 * ResourceDisplay is associated with the MultipleInstanceSelector, and it will
...
public class MultipleInstanceSelector extends JPanel {
	...
	public MultipleInstanceSelector(OWLModel okb, Project project,
			OWLSResourceDisplay editor) {
	...
	/*
	 * Creates one instance pane for each class using the factory, and adds them
	 * to this JPanel.
	 */
	private void createInstancePanes() {
		...
		while (it.hasNext()) {
			...
			OWLSInstanceList list = OWLSInstanceListFactory.create(_project,
					cls);
