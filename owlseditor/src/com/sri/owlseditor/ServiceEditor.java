...
/**
   This class is the right portion of the OWL-S tab. It changes
   contents depending on the selections made in the ServiceSelector on
   the left. The ServiceEditor is where most of the real work happens.
*/
public class ServiceEditor extends JPanel implements OWLSResourceDisplay { 
    ...
    /* Change the editor and options panes to show the properties and options for
       the selected instance. The reason for the paintAll calls below is that there
       is something strange going on with the repainting in the new Protege 3 UI.
       */
