...
public class SearchOptions extends OptionPanel {
	...
	public SearchOptions(Project project){
    	...
    	add(inquiryURLfield);
    	String inquiryURL = (String)project.getClientInformation(OWLSEDITOR_UDDI_INQUIRY_URL_KEY);
    	if (inquiryURL == null)
    	...
    	add(publishURLfield);
    	String publishURL = (String)project.getClientInformation(OWLSEDITOR_UDDI_PUBLISH_URL_KEY);
    	if (publishURL == null)
    	...
    	add(usernamefield);
    	String username = (String)project.getClientInformation(OWLSEDITOR_UDDI_USERNAME_KEY);
    	if (username == null)
    	...
    	add(passwordfield);
    	String password = (String)project.getClientInformation(OWLSEDITOR_UDDI_PASSWORD_KEY);
    	if (password == null)
	...
	public void commitChanges(){
		project.setClientInformation(OWLSEDITOR_UDDI_INQUIRY_URL_KEY, inquiryURLfield.getText());
		project.setClientInformation(OWLSEDITOR_UDDI_PUBLISH_URL_KEY, publishURLfield.getText());
		project.setClientInformation(OWLSEDITOR_UDDI_USERNAME_KEY, usernamefield.getText());
		project.setClientInformation(OWLSEDITOR_UDDI_PASSWORD_KEY, passwordfield.getText());
	}
