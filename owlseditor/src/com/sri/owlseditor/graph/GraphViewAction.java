...
/*	public GraphViewAction(OWLModel okb) {
		super("", OWLSIcons.getGraphViewIcon());
		System.out.println("GRPH DISPLAY ------------>>>>>>>>>>>>> knowledgeBase = " + okb);
	}
*/	
	
	public GraphViewAction(GraphDisplay graphDisplay) {
		super("", OWLSIcons.getGraphViewIcon());
		//System.out.println("GraphViewAction() ---> GraphDisplay = " + graphDisplay);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (_graphDisplay!=null)
		{
			...
			_graphDisplay.setDefaultCloseOperation(WindowConstants.HIDE_ON_CLOSE);
