...
/**
 * All node creation should go through this class. Some of the methods belong to
 * the NodeFactory interface of IJTree.
 * 
 */
public class OWLSTreeNodeFactory implements NodeFactory, CleanerListener {
	...
	public static OWLSTreeNodeFactory getInstance(OWLModel okb) {
		if (instance == null) {
			...
			if (instance.okb != okb) {
				System.out
						.println("This OWLSTreeNodeFactory was created with a different"
	...
	/**
	 * Returns an instance of one of the subclasses of OWLSTreeNode based on the
	 * type of control construct instance.
	 * 
	 * @param inst
	 */
	...
	public static OWLSTreeNode createTreeNode(OWLSTreeNodeInfo ni) {
		...
		if (inst == null) {
			System.out
					.println("ERROR! OWLSTreeNodeFactory.createTreeNode: inst is null");
		}
