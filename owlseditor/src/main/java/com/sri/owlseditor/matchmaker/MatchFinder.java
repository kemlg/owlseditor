...
public abstract class MatchFinder extends JFrame {
	...
	private class MatchesTableModel extends AbstractTableModel {
		...
		private String[] columnNames = { "Matching process", "Match degree",
				"Source" };

		/*
		 * public MatchesTableModel(List matchResults){ super();
		...
		class HelpAction extends AbstractAction {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frame,
						"This is an unhelpful help message.", "Help",
	...
	/**
	 * Brings up the window and shows the matches for the given perform. The
	 * process:process property of the given perform must be filled.
	 */
	public void show(OWLIndividual perform, OWLIndividual parent) {
		...
		// Matchmaker.getInstance(process.getOWLModel());
