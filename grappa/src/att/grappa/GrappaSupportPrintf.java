				...
				if ((n = cvt.parse(format, n)) < flen) {
					...
					case 'c':
						...
						if (args[argn] instanceof Character)
							cvt.buildChar(prtbuf,
									((Character) args[argn++]).charValue());
						else
							throw new RuntimeException("argument " + argn
					...
					case 'd':
						...
						if (args[argn] instanceof Number)
							cvt.buildInteger(prtbuf,
									((Number) args[argn++]).intValue());
						else
							throw new RuntimeException("argument " + argn
									+ " should be a Number");
						break;
					...
					case 'x':
						...
						if (args[argn] instanceof Character)
							...
							cvt.buildHex(prtbuf,
									((Number) args[argn++]).intValue(), false);
						else
							throw new RuntimeException("argument " + argn
									+ " should be a Character or Number");
						break;
					...
					case 'X':
						...
						if (args[argn] instanceof Character)
							...
							cvt.buildHex(prtbuf,
									((Number) args[argn++]).intValue(), true);
						else
							throw new RuntimeException("argument " + argn
									+ " should be a Character or Number");
						break;
					...
					case 'E':
						...
						if (args[argn] instanceof Character)
							...
							cvt.buildExp(prtbuf,
									((Number) args[argn++]).doubleValue(), true);
						else
							throw new RuntimeException("argument " + argn
									+ " should be a Character or Number");
						break;
