...
class CUP$Parser$actions {
			...
			if ((attr = (Attribute) (attrs.elementAt(i))).getValue() == null) {
				...
				case Grappa.NODE:
					parser.debug_message(1,
							"adding node default attr (" + attr.getName()
									+ ") to thisGraph(" + thisGraph.getName()
									+ ")");
					thisGraph.setNodeAttribute(attr);
					break;
				case Grappa.EDGE:
					parser.debug_message(1,
							"adding edge default attr (" + attr.getName()
									+ ") to thisGraph(" + thisGraph.getName()
									+ ")");
				...
				case Grappa.SUBGRAPH:
					parser.debug_message(1,
							"adding subg default attr (" + attr.getName()
									+ ") to thisGraph(" + thisGraph.getName()
									+ ")");
	...
	void appendNode(String name, String port) {
		if ((thisNode = rootSubgraph.findNodeByName(name)) == null) {
			parser.debug_message(1,
					"Creating node in subgraph (" + thisGraph.getName()
							+ ")...");
		...
		for (int i = 1; i < edges.size(); i++) {
			...
			if (((Boolean) (tailPair[1])).booleanValue()) { // true if node list
				...
				while (enum1.hasMoreElements()) {
					edgeRHS((Node) (enum1.nextElement()), null, headPair, key,
							name);
				}
			}
			tailPair = headPair;
	...
	void edgeRHS(Node tail, String tailPort, Object[] headPair,
		...
		if (((Boolean) (headPair[1])).booleanValue()) { // true if node list
			...
			while (enum1.hasMoreElements()) {
				thisEdge = new Edge(thisGraph, tail, tailPort,
						(Node) (enum1.nextElement()), null, key, name);
				parser.debug_message(1, "Creating edge in subgraph ("
						+ thisGraph.getName() + ")...");
				parser.debug_message(1, "thisEdge(" + thisEdge.getName() + ")");
				thisElemType = Grappa.EDGE;
	...
	public final java_cup.runtime.Symbol CUP$Parser$do_action(
		...
		case 62: // optSeparator ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(17/* optSeparator */,
		...
		case 59: // optSemi ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(16/* optSemi */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 57: // optSubgHdr ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(5/* optSubgHdr */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		{
			String RESULT = null;
			int valleft = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).left;
			int valright = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).right;
			String val = (String) ((java_cup.runtime.Symbol) CUP$Parser$stack
		...
		case 54: // subgraph ::= optSubgHdr NT$2 body
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(22/* subgraph */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 2)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 53: // NT$2 ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(34/* NT$2 */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 51: // attrMacro ::= ATSIGN ATOM
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(30/* attrMacro */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 1)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 50: // attrAssignment ::= ATOM EQUAL ATOM
		{
			...
			String name = (String) ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 2)).value;
			int valueleft = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).left;
			int valueright = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).right;
			String value = (String) ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).value;
		...
		case 49: // attrItem ::= attrMacro
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(28/* attrItem */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 47: // attrDefs ::= attrDefs optSeparator attrItem
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(27/* attrDefs */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 2)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 45: // optAttrDefs ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(26/* optAttrDefs */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 43: // attrList ::= optAttr LBR optAttrDefs RBR
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(24/* attrList */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
		...
		case 42: // optAttr ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(20/* optAttr */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 40: // optMacroName ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(7/* optMacroName */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 38: // attrType ::= EDGE
		{
			...
			int valright = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).right;
			Integer val = (Integer) ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).value;

			RESULT = new Integer(Grappa.EDGE);

			CUP$Parser$result = new java_cup.runtime.Symbol(4/* attrType */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 35: // attrStmt ::= graphAttrDefs
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(15/* attrStmt */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 34: // attrStmt ::= attrType optMacroName attrList
		{
			...
			int typeright = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 2)).right;
			Integer type = (Integer) ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 2)).value;
			int nameleft = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 1)).left;
			int nameright = ((java_cup.runtime.Symbol) CUP$Parser$stack
		...
		case 33: // optPort ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(8/* optPort */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 31: // node ::= ATOM optPort
		{
			...
			String name = (String) ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 1)).value;
			int portleft = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).left;
			int portright = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).right;
			String port = (String) ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).value;

			appendNode(name, port);

			CUP$Parser$result = new java_cup.runtime.Symbol(23/* node */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 1)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 30: // nodeList ::= nodeList COMMA node
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(21/* nodeList */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 2)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 28: // rCompound ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(3/* rCompound */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 27: // rCompound ::= edge_op NT$1 simple rCompound
		{
			...
			if (((java_cup.runtime.Symbol) CUP$Parser$stack
				...
				RESULT = (Boolean) ((java_cup.runtime.Symbol) CUP$Parser$stack
						.elementAt(CUP$Parser$top - 2)).value;
			int valleft = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).left;
			int valright = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).right;
			Boolean val = (Boolean) ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).value;
		...
		case 26: // NT$1 ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(33/* NT$1 */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 25: // edge_op ::= ND_EDGE_OP
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(31/* edge_op */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 23: // simple ::= subgraph
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(19/* simple */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 21: // compound ::= simple rCompound optAttr
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(18/* compound */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 2)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 18: // stmtList ::= stmt
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(13/* stmtList */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 16: // optStmtList ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(12/* optStmtList */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 14: // body ::= LCUR optStmtList RCUR
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(11/* body */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 2)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 13: // optGraphName ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(6/* optGraphName */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 11: // graphType ::= DIGRAPH
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(2/* graphType */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 9: // optStrict ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(1/* optStrict */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 7: // hdr ::= STRICTDIGRAPH optGraphName
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(10/* hdr */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 1)).left,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		{
			Object RESULT = null;
			int strictleft = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 2)).left;
			int strictright = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 2)).right;
			Boolean strict = (Boolean) ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 2)).value;
			int typeleft = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 1)).left;
			int typeright = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 1)).right;
			Boolean type = (Boolean) ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 1)).value;
			int nameleft = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).left;
			int nameright = ((java_cup.runtime.Symbol) CUP$Parser$stack
		...
		case 4: // graph ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(9/* graph */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
		...
		case 3: // graph ::= error
		{
			...
			int valright = ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).right;
			Object val = (Object) ((java_cup.runtime.Symbol) CUP$Parser$stack
					.elementAt(CUP$Parser$top - 0)).value;
		...
		case 1: // NT$0 ::=
		{
			...
			CUP$Parser$result = new java_cup.runtime.Symbol(32/* NT$0 */,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right,
					((java_cup.runtime.Symbol) CUP$Parser$stack
							.elementAt(CUP$Parser$top - 0)).right, RESULT);
